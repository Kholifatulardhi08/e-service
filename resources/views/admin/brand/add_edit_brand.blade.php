                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" @if(!empty($brand['id']))
                            ...
                            action="{{ url('admin/add-edit-brand/'.$brands['id']) }}" @endif method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama"
                                    @if(!empty($brands['nama'])) value="{{ $brands['nama'] }}" @else
                                    value="{{ old('nama') }}" @endif placeholder="Masukkan nama brand anda" required>
                            </div>
