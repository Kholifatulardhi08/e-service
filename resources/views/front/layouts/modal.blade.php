                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 u-s-p-x-0">
                        <div class="newsletter-image">
                            <a target="_blank" rel="nofollow" href="https://youtube.com/stackdevelopers"
                                ...
                                <img class="img-fluid" src="{{ url('front/images/banners/stack-developers-modal-popup.png') }}"
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <!-- Product-zoom-area -->
                        <div class="zoom-area">
                            <img id="zoom-pro-quick-view" class="img-fluid" src="{{ url('front/images/product/product@4x.jpg')  }}"
                                data-zoom-image="{{ url('front/images/product/product@4x.jpg')  }}" alt="Zoom Image">
